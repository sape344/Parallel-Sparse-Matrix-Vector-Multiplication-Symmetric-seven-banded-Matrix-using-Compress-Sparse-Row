...
int main(int argc, char **argv){
    ...
    deftype *CResult;
    int *RowVector;
    int *ColVector;a#include <iostream>
#include <random>
#include <chrono>
#include <sys/time.h>
#include "mpi.h"
...
int main(int argc, char **argv){
  ...
  //  std::cout<<"Size= "<<SIZE<<"\n";
   ...
   /* MPI_Iscatterv(AValVector,Matrix[1],Matrix[0],MPI_DOUBLE,LocAValVector,Matrix[1][rank],MPI_DOUBLE,0,MPI_COMM_WORLD,&requestA);
    MPI_Iscatterv(BVector,Matrix[3],Matrix[2],MPI_DOUBLE,LocBVector,Matrix[3][rank],MPI_DOUBLE,0,MPI_COMM_WORLD,&requestB);
    ...
    //MPI_Igatherv(LocCResult,local_size,MPI_DOUBLE,CResult,Matrix[5],Matrix[4],MPI_DOUBLE,0,MPI_COMM_WORLD,&requestA);
...
A* SpMVParellel(A *ValAVector, A* BVector,int rank,int localsize,int nproc){
    ...
    {   
      ...
      //  stop=std::chrono::high_resolution_clock::now();
//        std::cout << "elapsed time for parelel : " << std::chrono::duration<double> (stop-start).count() << "\n";
        std::cout << "elapsed time for parelel : " << (stopTime-startTime) << "\n";
        ...
        //stop=std::chrono::high_resolution_clock::now();
        //std::cout << "elapsed time for Clasic : " << std::chrono::duration<double> (stop-start).count() << "\n";
        std::cout << "elapsed time for Clasic : " << (stopTime-startTime)<< "\n";
